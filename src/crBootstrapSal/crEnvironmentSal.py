...
def init_environment_sal():
    ...
    _magic_value_config_local = _crGlobalLevel.magic_value_config
...
def apply_environment_config_preprocessor():
    # m = my
    mD = _crGlobalLevel.environment_config['data']
    mDC = _crGlobalLevel.environment_config['data_catalog_html_resource']

    # Copy data structure to output structure
    # Do this before preprocess data
    _crGlobalLevel.environment_config['output_catalog_html_resource'] = mDC

    # Generate full path for data_catalog folder
    _crGlobalLevel.environment_config['data_catalog_html_resource']['root_full_path'] = mD['root_path'] + mDC['root_path']
